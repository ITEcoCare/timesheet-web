...
const TimesheetEventModal = () => {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            project_name: "Kejar Timesheet",
            activity: "Patching DB X",
        },
        onSubmit: (values, actions) => {
            alert(JSON.stringify(values, null, 2));
            // createProject(accessToken, values)
            // createTsByGetProj(accessToken, values)
            createTimesheet(accessToken, values.project_name)
            ...
            <div className="flex flex-col fixed min-h-screen w-full z-20 bg-stone-800 bg-opacity-90 left-0 top-0 justify-center items-center">
                <div className=" bg-gray-100 w-[100vh] lg:w-[80vh] md:w-[60vh] sm:w-[40vh] h-full rounded-xl">
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        <div className="m-3 grid grid-cols-1 sm:grid-cols-1">

                            <span className="font-bold text-2xl flex ml-4 text-green-500">Create timesheet! </span>
                            ...
                            <label className={labelClass}>
                                ...
                                <input
                                    ...
                                    className={
                                        " w-full fill-white dark:bg-stone-800 hover:bg-white-400  py-2 px-4 border-b-4 dark:border-stone-900 border-gray-200 rounded-r-xl shadow-inner hover:bg-gray-100 "
                                    }
                                />
                            </label>
                            <label className={labelClass}>
                                <label className="bg-blue-500 text-white font-bold py-2 px-1 border-b-4 border-blue-700 rounded-l-xl">
                                    Day 1
                                </label>
                                <input
                                    type="text"
