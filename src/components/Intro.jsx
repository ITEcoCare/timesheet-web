    ...
    return (
        ...
        Intro iz Hom Content
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                ...
                >
                    <span className="text-xs bg-green-600 rounded-full text-white px-4 py-1.5 mr-3" onClick={()=>{
                      console.log("uawauuw")
                      }}>
                        New
                    </span>{" "}
                ...
                (
                    <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-stone-900 md:text-5xl lg:text-6xl dark:text-white">
                        This is Timesheet, Let's sign in!
                    </h1>
                ) : (
                    <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-stone-900 md:text-5xl lg:text-6xl dark:text-white">
                        Welcome to Timesheet, 
                        <span className={`${theme == 'light' ? 'text-blue-500' : 'text-gray-50'}`}>
                        { ` ${myUser.user_role_name == "ROOT" ? myUser.user_role_name : myUser.employee_fullname}.`}
                        </span>
                    </h1>
                )
}
                <p className="mb-8 text-lg font-normal text-stone-500 lg:text-xl sm:px-16 lg:px-48 dark:text-stone-200">
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                <div className="bg-blue-500 dark:bg-stone-800 border border-stone-200 dark:border-stone-700 rounded-lg p-8 md:p-12 mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="bg-stone-50 dark:bg-stone-800 border border-stone-200 dark:border-stone-700 rounded-lg p-8 md:p-12">
                        <a
                            href="#"
                            className="bg-green-100 text-green-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md dark:bg-stone-700 dark:text-green-400 mb-2"
                        >
